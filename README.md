...
Primeiramente deve-se clonar o repositório no [endereço](https://github.com/efmendes/treinamento_202201.git).
...
Para acesso à sua API desenvolvida, utilize o endereço:

```http://localhost:8080/treinamento```
